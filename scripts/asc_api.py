...
BUNDLE_ID = "com.tokyonasu.BodyReader"
...
def get_localization_id(version_id):
    ...
    payload = api("POST", "/appStoreVersionLocalizations", json={
        "data": {
            ...
            "attributes": {
                "locale": "ja",
                "description": "体の動きから相手の本音を読み解く。腕組み、視線、姿勢など日常のボディランゲージを分析して、隠された感情や意図を解説します。",
                "keywords": "ボディランゲージ,心理,読心術,しぐさ,本音,コミュニケーション,非言語,表情,分析",
